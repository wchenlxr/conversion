...
public class RangeContrastController {
	...
	public String searchRangeContrast(
		...
		String re = null;
		if (type == null) {
			re = rangeContrastService.getRangeContrast(page, rows, companyCode, platformRangeCode, ppFlag);
		} else {
			re = rangeContrastService.searchRangeContrast(page, rows, companyCode, platformRangeCode, type, value, ppFlag);
		}
		return re;
	}
